...
document.querySelectorAll('.role-tab').forEach(tab => {
  ...
  const patientCPaswwordInput = document.getElementById('cPassword');
  const passwordContainer = document.querySelector('.patientPasswordContainer');
  const cPasswordContainer = document.querySelector('.patientCpasswordContainer');
  ...
  async function registerPatient()  {
    ...
    //check password
    if (password === '') {
        passwordContainer.classList.add('errors');
        passwordMessage.textContent = 'Password cannot be empty';
        isValid = false;
    }  else {
        passwordContainer.classList.remove('errors');
        passwordMessage.textContent = '';
    };

    //check confirm password
    if (cPassword  === '') {
        cPasswordContainer.classList.add('errors');
        cpMessage.textContent = 'Confirm Password cannot be empty';
        isValid = false;
    } else {
        cPasswordContainer.classList.remove('errors');
...
//REAL TIME FEEDBACK
  emailInput.addEventListener('input', () => {
    ...
    patientCPaswwordInput.addEventListener('input', () => {
        if (passwordInput.value !== patientCPaswwordInput.value) {
            cPasswordContainer.classList.add('errors');
...
const doctorPasswordContainer = document.querySelector('.doctorPasswordContainer');
  const doctorCpasswordContainer = document.querySelector('.doctorCpasswordContainer');
...
const adminCpasswordContainer = document.querySelector('.adminCpasswordContainer');
...
async function adminRegistration() {
    ...
    //check confirm password
    if (cPasswordValue === "") {
        adminCpasswordContainer.classList.add('errors');
        admincpMessage.textContent = "Confirm Password cannot be empty.";
        isValid = false;
    } else {
        adminCpasswordContainer.classList.remove('errors');
